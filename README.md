...
Проєкт розробляється поетапно (фази 0–6, див. ТЗ, розділ 15). Гілка `main` захищена (обов'язковий CI-чек `build` + 1 рев'ю перед злиттям), зміни йдуть через Pull Request.
