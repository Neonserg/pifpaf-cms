// Auto-generated from the pifpaf-cms Supabase project schema.
// Regenerate with the Supabase MCP `generate_typescript_types` tool after
// every migration and commit the result — do not hand-edit.
  ...
  public: {
    Tables: {
      ...
      settings: {
        ...
        Relationships: [
          {
            foreignKeyName: "settings_home_page_id_fkey"
